...
for i in range(100):
    ...
    data.append({"Usuario": usuario, "Estande": estande, "Nota_Atendimento": nota_atendimento, "Nota_Organizacao": nota_organizacao, "Nota_Aparencia": nota_aparencia, "Nota_Variedade": nota_variedade})

# Criação do arquivo CSV
with open("dados.csv", "w", newline="") as f:
    fieldnames = ["Usuario", "Estande", "Nota_Atendimento", "Nota_Organizacao", "Nota_Aparencia", "Nota_Variedade"]
